...
abstract final class IsarCore {
  static final bool kIsWeb = DartUtils.isWeb;
  ...
  static final Pointer<Pointer<Uint8>> stringPtrPtr = ptrPtr.cast<Pointer<Uint8>>();
  static Pointer<Uint8> get stringPtr => stringPtrPtr.ptrValue;

  static final Pointer<Pointer<CIsarReader>> readerPtrPtr = ptrPtr.cast<Pointer<CIsarReader>>();
  ...
  static FutureOr<void> _initialize({
    ...
    final result = platform.initializeBindings(
      library: library,
