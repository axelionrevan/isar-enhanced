...
import 'package:isar/source/native/bindings.dart';
import 'package:isar/source/native/isolate_pool.dart';
...
class IsarCorePlatformImpl implements IsarCorePlatform {
  ...
  FutureOr<IsarCoreBindings> initializeBindings({
    ...
    final Version versionProcces = Version.parse(coreVersion);

    if (versionProcces >= Isar.currentVersion) {
